<template>
   <div class="w-full h-[200px] mt-40 bg-primary flex flex-row items-center justify-between p-16">
      <div>
         <p class="text-white text-[24px]">Created by Dawid Matiaszewski</p>
         <p class="text-white text-[12px]">Inspired by Mobirise</p>
      </div>
